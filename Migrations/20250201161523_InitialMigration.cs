        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ColorName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Code = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Dob = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StartDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SaleName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Status = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StartDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    Code = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountValue = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    MinimumOrderValue = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    MaxDiscount = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    Code = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    UpdateDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    InitialTotalAmount = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    Note = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OrderDate = table.Column<DateTime>(type: "datetime(6)", maxLength: 100, nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    VoucherId = table.Column<int>(type: "int", nullable: false),
                    Code = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cart_ProductDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cart_ProductDetails_Carts_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "Carts",
                        principalColumn: "CartId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cart_ProductDetails_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discount = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    TotalAmount = table.Column<decimal>(type: "decimal(65,30)", maxLength: 100, nullable: false),
                    Note = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDetail_Sales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductDetail_Sales_ProductDetails_ProductDetailId",
                        column: x => x.ProductDetailId,
                        principalTable: "ProductDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDetail_Sales_Sales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cart_ProductDetails_ProductDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_Sales_ProductDetailId",
                table: "ProductDetail_Sales",
                column: "ProductDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDetail_Sales_SaleId",
                table: "ProductDetail_Sales",
                column: "SaleId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDetails_Code",
