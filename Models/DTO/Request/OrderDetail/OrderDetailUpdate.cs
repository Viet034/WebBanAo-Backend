...
namespace WebBanAoo.Models.DTO.Request.OrderDetail
{
    public class OrderDetailUpdate
    {
        ...
        public OrderDetailUpdate(int id, string code, OrderDetailStatus status, int quantity, decimal unitPrice, decimal discount, decimal totalAmount, string? note, int orderId, int productDetailId)
        {
            Id = id;
            Code = code;
            Status = status;
