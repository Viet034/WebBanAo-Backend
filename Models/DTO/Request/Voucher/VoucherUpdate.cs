...
namespace WebBanAoo.Models.DTO.Request.Voucher
{
    public class VoucherUpdate
    {
        ...
        public VoucherUpdate(int id, string code, string name, string description, VoucherStatus status, DateTime startDate, DateTime endDate, int quantity, decimal discountValue, decimal minimumOrderValue, decimal maxDiscount)
        {
            Id = id;
            Code = code;
            Name = name;
